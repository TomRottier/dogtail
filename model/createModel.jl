...
function createModel(fname)
    ...
    # Initial conditions
    u₀ = SVector{12,Float64}(initconds)
	...
	function eom(u, p, t)
	    ...
	    atorx, atory, atorz = 0.0, 0.0, 0.0 # -ka * rotation_angle(r1) * rotation_axis(r1) .- ba * [u1,u2,u3]
	    btorx, btory, btorz = 0.0, 0.0, 0.0 # -kb * rotation_angle(r2) * rotation_axis(r2) .- bb * [u4,u5,u6]
		...
		z[239] = z[204] + z[215]
		z[244] = z[208] + z[214] + z[219] * (z[39] * z[109] - pxpp * z[152] - pypp * z[153] - pzpp * z[154] - z[34] * z[108] - z[134] - z[42] * z[110])
		z[249] = z[212] + z[213] - z[219] * (z[33] * z[108] - pxpp * z[149] - pypp * z[150] - pzpp * z[151] - z[133] - z[38] * z[109] - z[41] * z[110])
		z[250] = z[155] - z[222]
		z[251] = z[157] - z[231]
		z[252] = z[158] - z[238]
		z[253] = btorx - z[239]
	    ...
	    coef = @SMatrix [coef11 coef12 coef13 coef14 coef15 coef16
						 coef21 coef22 coef23 coef24 coef25 coef26
						 coef31 coef32 coef33 coef34 coef35 coef36
						 coef41 coef42 coef43 coef44 coef45 coef46
						 coef51 coef52 coef53 coef54 coef55 coef56
						 coef61 coef62 coef63 coef64 coef65 coef66]
	
	    rhs = @SVector [rhs1, rhs2, rhs3, rhs4, rhs5, rhs6]
	
	    @inbounds u1p, u2p, u3p, u4p, u5p, u6p = coef \ rhs
