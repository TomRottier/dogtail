...
C**   Created by AUTOLEV 3.2 on Thu Jul 01 14:02:52 2021
      ...
      EXTERNAL         EQNS1
      DIMENSION        VAR(12)
      COMMON/CONSTNTS/ BA,BB,G,IXA,IXB,IYA,IYB,IZA,IZB,KA,KB,LA,LAO,LB,L
     &BO,MA,MB
...
C**   Read values of constants from input file
      READ(20,7010,END=7100,ERR=7101) BA,BB,G,IXA,IXB,IYA,IYB,IZA,IZB,KA
     &,KB,LA,LAO,LB,LBO,MA,MB
...
C**   Quantities to be specified
     ...
     &(COS(Q4)*COS(Q6)-SIN(Q4)*SIN(Q5)*SIN(Q6)))
      ...
      RHS(1) = KA*Q1 + BA*U1 + IYB*SIN(Q6)*COS(Q5)*(U4*(SIN(Q4)*COS(Q5)*
     &U2-U6-SIN(Q5)*U1-COS(Q4)*COS(Q5)*U3)+U6*(U4+COS(Q5)*COS(Q6)*U1+(SI
     &N(Q6)*COS(Q4)+SIN(Q4)*SIN(Q5)*COS(Q6))*U2+(SIN(Q4)*SIN(Q6)-SIN(Q5)
     &*COS(Q4)*COS(Q6))*U3)) + IXB*COS(Q5)*COS(Q6)*(U5*(SIN(Q4)*COS(Q5)*
     &U2-U6-SIN(Q5)*U1-COS(Q4)*COS(Q5)*U3)-U6*(SIN(Q6)*COS(Q5)*U1-U5-(SI
     &N(Q4)*COS(Q6)+SIN(Q5)*SIN(Q6)*COS(Q4))*U3-(COS(Q4)*COS(Q6)-SIN(Q4)
     &*SIN(Q5)*SIN(Q6))*U2)) + IZB*SIN(Q5)*(U5*(U4+COS(Q5)*COS(Q6)*U1+(S
     &IN(Q6)*COS(Q4)+SIN(Q4)*SIN(Q5)*COS(Q6))*U2+(SIN(Q4)*SIN(Q6)-SIN(Q5
     &)*COS(Q4)*COS(Q6))*U3)+U4*(SIN(Q6)*COS(Q5)*U1-U5-(SIN(Q4)*COS(Q6)+
     &SIN(Q5)*SIN(Q6)*COS(Q4))*U3-(COS(Q4)*COS(Q6)-SIN(Q4)*SIN(Q5)*SIN(Q
     &6))*U2)) + LBO*MB*(PXpp*SIN(Q6)*COS(Q5)*(SIN(Q2)*COS(Q4)*COS(Q5)+S
     &IN(Q5)*COS(Q2)*COS(Q3)+SIN(Q3)*SIN(Q4)*COS(Q2)*COS(Q5))+PXpp*SIN(Q
     &5)*(SIN(Q2)*(SIN(Q4)*COS(Q6)+SIN(Q5)*SIN(Q6)*COS(Q4))-SIN(Q6)*COS(
     &Q2)*COS(Q3)*COS(Q5)-SIN(Q3)*COS(Q2)*(COS(Q4)*COS(Q6)-SIN(Q4)*SIN(Q
     &5)*SIN(Q6)))+PZpp*SIN(Q6)*COS(Q5)*(COS(Q1)*COS(Q2)*COS(Q4)*COS(Q5)
     &+SIN(Q5)*(SIN(Q1)*SIN(Q3)-SIN(Q2)*COS(Q1)*COS(Q3))-SIN(Q4)*COS(Q5)
     &*(SIN(Q1)*COS(Q3)+SIN(Q2)*SIN(Q3)*COS(Q1)))+PYpp*SIN(Q6)*COS(Q5)*(
     &SIN(Q5)*(SIN(Q3)*COS(Q1)+SIN(Q1)*SIN(Q2)*COS(Q3))-SIN(Q1)*COS(Q2)*
     &COS(Q4)*COS(Q5)-SIN(Q4)*COS(Q5)*(COS(Q1)*COS(Q3)-SIN(Q1)*SIN(Q2)*S
     &IN(Q3)))+LA*SIN(Q6)*COS(Q4)*COS(Q5)**2*U1*U3+LA*SIN(Q5)*(SIN(Q4)*C
     &OS(Q6)+SIN(Q5)*SIN(Q6)*COS(Q4))*U1*U3+LA*SIN(Q5)*(COS(Q4)*COS(Q6)-
     &SIN(Q4)*SIN(Q5)*SIN(Q6))*U1*U2+LBO*SIN(Q5)*(COS(Q5)*U1*Q5p+SIN(Q4)
     &*SIN(Q5)*U2*Q5p-(U4+COS(Q5)*COS(Q6)*U1+(SIN(Q6)*COS(Q4)+SIN(Q4)*SI
     &N(Q5)*COS(Q6))*U2+(SIN(Q4)*SIN(Q6)-SIN(Q5)*COS(Q4)*COS(Q6))*U3)*(S
     &IN(Q6)*COS(Q5)*U1-U5-(SIN(Q4)*COS(Q6)+SIN(Q5)*SIN(Q6)*COS(Q4))*U3-
     &(COS(Q4)*COS(Q6)-SIN(Q4)*SIN(Q5)*SIN(Q6))*U2)-SIN(Q4)*COS(Q5)*U3*Q
     &4p-SIN(Q5)*COS(Q4)*U3*Q5p-COS(Q4)*COS(Q5)*U2*Q4p)-PYpp*SIN(Q5)*(SI
     &N(Q1)*COS(Q2)*(SIN(Q4)*COS(Q6)+SIN(Q5)*SIN(Q6)*COS(Q4))+SIN(Q6)*CO
     &S(Q5)*(SIN(Q3)*COS(Q1)+SIN(Q1)*SIN(Q2)*COS(Q3))-(COS(Q1)*COS(Q3)-S
     &IN(Q1)*SIN(Q2)*SIN(Q3))*(COS(Q4)*COS(Q6)-SIN(Q4)*SIN(Q5)*SIN(Q6)))
     &-PZpp*SIN(Q5)*(SIN(Q6)*COS(Q5)*(SIN(Q1)*SIN(Q3)-SIN(Q2)*COS(Q1)*CO
     &S(Q3))-COS(Q1)*COS(Q2)*(SIN(Q4)*COS(Q6)+SIN(Q5)*SIN(Q6)*COS(Q4))-(
     &SIN(Q1)*COS(Q3)+SIN(Q2)*SIN(Q3)*COS(Q1))*(COS(Q4)*COS(Q6)-SIN(Q4)*
     &SIN(Q5)*SIN(Q6)))-LA*SIN(Q4)*SIN(Q6)*COS(Q5)**2*U1*U2-LBO*SIN(Q6)*
     &COS(Q5)*((SIN(Q4)*COS(Q5)*U2-U6-SIN(Q5)*U1-COS(Q4)*COS(Q5)*U3)*(U4
     ...
     &S(Q4)*COS(Q5)*Q5p))) - G*LBO*MB*(SIN(Q6)*COS(Q5)*(COS(Q1)*COS(Q2)*
     &COS(Q4)*COS(Q5)+SIN(Q5)*(SIN(Q1)*SIN(Q3)-SIN(Q2)*COS(Q1)*COS(Q3))-
     &SIN(Q4)*COS(Q5)*(SIN(Q1)*COS(Q3)+SIN(Q2)*SIN(Q3)*COS(Q1)))-SIN(Q5)
     &*(SIN(Q6)*COS(Q5)*(SIN(Q1)*SIN(Q3)-SIN(Q2)*COS(Q1)*COS(Q3))-COS(Q1
     &)*COS(Q2)*(SIN(Q4)*COS(Q6)+SIN(Q5)*SIN(Q6)*COS(Q4))-(SIN(Q1)*COS(Q
     &3)+SIN(Q2)*SIN(Q3)*COS(Q1))*(COS(Q4)*COS(Q6)-SIN(Q4)*SIN(Q5)*SIN(Q
     &6)))) - (IYA-IZA)*U2*U3 - SIN(Q6)*COS(Q5)*(IXB*U4*U6+IXB*SIN(Q5)*U
     &1*U4+IXB*COS(Q4)*COS(Q5)*U3*U4+IXB*COS(Q5)*COS(Q6)*U1*U6+IZB*SIN(Q
     &4)*COS(Q5)*U2*U4+IXB*SIN(Q5)*COS(Q5)*COS(Q6)*U1**2+IXB*COS(Q4)*COS
     &(Q6)*COS(Q5)**2*U1*U3+IZB*SIN(Q4)*COS(Q6)*COS(Q5)**2*U1*U2+IXB*(SI
     &N(Q6)*COS(Q4)+SIN(Q4)*SIN(Q5)*COS(Q6))*U2*U6+IXB*(SIN(Q4)*SIN(Q6)-
     &SIN(Q5)*COS(Q4)*COS(Q6))*U3*U6+IXB*SIN(Q5)*(SIN(Q6)*COS(Q4)+SIN(Q4
     &)*SIN(Q5)*COS(Q6))*U1*U2+IXB*SIN(Q5)*(SIN(Q4)*SIN(Q6)-SIN(Q5)*COS(
     &Q4)*COS(Q6))*U1*U3+IXB*COS(Q4)*COS(Q5)*(SIN(Q6)*COS(Q4)+SIN(Q4)*SI
     &N(Q5)*COS(Q6))*U2*U3+IZB*SIN(Q4)*COS(Q5)*(SIN(Q6)*COS(Q4)+SIN(Q4)*
     &SIN(Q5)*COS(Q6))*U2**2+IXB*COS(Q4)*COS(Q5)*(SIN(Q4)*SIN(Q6)-SIN(Q5
     &)*COS(Q4)*COS(Q6))*U3**2+IZB*SIN(Q4)*COS(Q5)*(SIN(Q4)*SIN(Q6)-SIN(
     &Q5)*COS(Q4)*COS(Q6))*U2*U3-IZB*U4*U6-IZB*SIN(Q5)*U1*U4-IXB*SIN(Q4)
     &*COS(Q5)*U2*U4-IZB*COS(Q4)*COS(Q5)*U3*U4-IZB*COS(Q5)*COS(Q6)*U1*U6
     &-IZB*SIN(Q5)*COS(Q5)*COS(Q6)*U1**2-IXB*SIN(Q4)*COS(Q6)*COS(Q5)**2*
     &U1*U2-IZB*COS(Q4)*COS(Q6)*COS(Q5)**2*U1*U3-IZB*(SIN(Q6)*COS(Q4)+SI
     &N(Q4)*SIN(Q5)*COS(Q6))*U2*U6-IZB*(SIN(Q4)*SIN(Q6)-SIN(Q5)*COS(Q4)*
     &COS(Q6))*U3*U6-IZB*SIN(Q5)*(SIN(Q6)*COS(Q4)+SIN(Q4)*SIN(Q5)*COS(Q6
     &))*U1*U2-IZB*SIN(Q5)*(SIN(Q4)*SIN(Q6)-SIN(Q5)*COS(Q4)*COS(Q6))*U1*
     &U3-IXB*SIN(Q4)*COS(Q5)*(SIN(Q6)*COS(Q4)+SIN(Q4)*SIN(Q5)*COS(Q6))*U
     &2**2-IZB*COS(Q4)*COS(Q5)*(SIN(Q6)*COS(Q4)+SIN(Q4)*SIN(Q5)*COS(Q6))
     &*U2*U3-IXB*SIN(Q4)*COS(Q5)*(SIN(Q4)*SIN(Q6)-SIN(Q5)*COS(Q4)*COS(Q6
     &))*U2*U3-IZB*COS(Q4)*COS(Q5)*(SIN(Q4)*SIN(Q6)-SIN(Q5)*COS(Q4)*COS(
     &Q6))*U3**2) - COS(Q5)*COS(Q6)*(IYB*U5*U6+IYB*SIN(Q5)*U1*U5+IYB*COS
     &(Q4)*COS(Q5)*U3*U5+IZB*SIN(Q4)*COS(Q5)*U2*U5+IZB*SIN(Q6)*COS(Q5)*U
     &1*U6+IZB*SIN(Q5)*SIN(Q6)*COS(Q5)*U1**2+IYB*SIN(Q4)*SIN(Q6)*COS(Q5)
     &**2*U1*U2+IZB*SIN(Q6)*COS(Q4)*COS(Q5)**2*U1*U3+IYB*(SIN(Q4)*COS(Q6
     &)+SIN(Q5)*SIN(Q6)*COS(Q4))*U3*U6+IYB*(COS(Q4)*COS(Q6)-SIN(Q4)*SIN(
     &Q5)*SIN(Q6))*U2*U6+IYB*SIN(Q5)*(SIN(Q4)*COS(Q6)+SIN(Q5)*SIN(Q6)*CO
     &S(Q4))*U1*U3+IYB*SIN(Q5)*(COS(Q4)*COS(Q6)-SIN(Q4)*SIN(Q5)*SIN(Q6))
     &*U1*U2+IYB*COS(Q4)*COS(Q5)*(SIN(Q4)*COS(Q6)+SIN(Q5)*SIN(Q6)*COS(Q4
     &))*U3**2+IZB*SIN(Q4)*COS(Q5)*(SIN(Q4)*COS(Q6)+SIN(Q5)*SIN(Q6)*COS(
     &Q4))*U2*U3+IYB*COS(Q4)*COS(Q5)*(COS(Q4)*COS(Q6)-SIN(Q4)*SIN(Q5)*SI
     &N(Q6))*U2*U3+IZB*SIN(Q4)*COS(Q5)*(COS(Q4)*COS(Q6)-SIN(Q4)*SIN(Q5)*
     &SIN(Q6))*U2**2-IZB*U5*U6-IZB*SIN(Q5)*U1*U5-IYB*SIN(Q4)*COS(Q5)*U2*
     &U5-IYB*SIN(Q6)*COS(Q5)*U1*U6-IZB*COS(Q4)*COS(Q5)*U3*U5-IYB*SIN(Q5)
     &*SIN(Q6)*COS(Q5)*U1**2-IYB*SIN(Q6)*COS(Q4)*COS(Q5)**2*U1*U3-IZB*SI
     &N(Q4)*SIN(Q6)*COS(Q5)**2*U1*U2-IZB*(SIN(Q4)*COS(Q6)+SIN(Q5)*SIN(Q6
     &)*COS(Q4))*U3*U6-IZB*(COS(Q4)*COS(Q6)-SIN(Q4)*SIN(Q5)*SIN(Q6))*U2*
     &U6-IZB*SIN(Q5)*(SIN(Q4)*COS(Q6)+SIN(Q5)*SIN(Q6)*COS(Q4))*U1*U3-IZB
     &*SIN(Q5)*(COS(Q4)*COS(Q6)-SIN(Q4)*SIN(Q5)*SIN(Q6))*U1*U2-IYB*SIN(Q
     &4)*COS(Q5)*(SIN(Q4)*COS(Q6)+SIN(Q5)*SIN(Q6)*COS(Q4))*U2*U3-IZB*COS
     &(Q4)*COS(Q5)*(SIN(Q4)*COS(Q6)+SIN(Q5)*SIN(Q6)*COS(Q4))*U3**2-IYB*S
     &IN(Q4)*COS(Q5)*(COS(Q4)*COS(Q6)-SIN(Q4)*SIN(Q5)*SIN(Q6))*U2**2-IZB
     &*COS(Q4)*COS(Q5)*(COS(Q4)*COS(Q6)-SIN(Q4)*SIN(Q5)*SIN(Q6))*U2*U3) 
     &- SIN(Q5)*(IXB*U4*U5+IXB*COS(Q5)*COS(Q6)*U1*U5+IYB*SIN(Q6)*COS(Q5)
     &*U1*U4+IYB*SIN(Q6)*COS(Q6)*COS(Q5)**2*U1**2+IXB*(SIN(Q4)*COS(Q6)+S
     &IN(Q5)*SIN(Q6)*COS(Q4))*U3*U4+IXB*(SIN(Q6)*COS(Q4)+SIN(Q4)*SIN(Q5)
     &*COS(Q6))*U2*U5+IXB*(SIN(Q4)*SIN(Q6)-SIN(Q5)*COS(Q4)*COS(Q6))*U3*U
     &5+IXB*(COS(Q4)*COS(Q6)-SIN(Q4)*SIN(Q5)*SIN(Q6))*U2*U4+IXB*COS(Q5)*
     &COS(Q6)*(SIN(Q4)*COS(Q6)+SIN(Q5)*SIN(Q6)*COS(Q4))*U1*U3+IYB*SIN(Q6
     &)*COS(Q5)*(SIN(Q6)*COS(Q4)+SIN(Q4)*SIN(Q5)*COS(Q6))*U1*U2+IXB*COS(
     &Q5)*COS(Q6)*(COS(Q4)*COS(Q6)-SIN(Q4)*SIN(Q5)*SIN(Q6))*U1*U2+IYB*SI
     &N(Q6)*COS(Q5)*(SIN(Q4)*SIN(Q6)-SIN(Q5)*COS(Q4)*COS(Q6))*U1*U3+IXB*
     &(SIN(Q4)*COS(Q6)+SIN(Q5)*SIN(Q6)*COS(Q4))*(SIN(Q6)*COS(Q4)+SIN(Q4)
     &*SIN(Q5)*COS(Q6))*U2*U3+IXB*(SIN(Q4)*COS(Q6)+SIN(Q5)*SIN(Q6)*COS(Q
     &4))*(SIN(Q4)*SIN(Q6)-SIN(Q5)*COS(Q4)*COS(Q6))*U3**2+IXB*(SIN(Q6)*C
     &OS(Q4)+SIN(Q4)*SIN(Q5)*COS(Q6))*(COS(Q4)*COS(Q6)-SIN(Q4)*SIN(Q5)*S
     &IN(Q6))*U2**2+IXB*(SIN(Q4)*SIN(Q6)-SIN(Q5)*COS(Q4)*COS(Q6))*(COS(Q
     &4)*COS(Q6)-SIN(Q4)*SIN(Q5)*SIN(Q6))*U2*U3-IYB*U4*U5-IXB*SIN(Q6)*CO
     &S(Q5)*U1*U4-IYB*COS(Q5)*COS(Q6)*U1*U5-IXB*SIN(Q6)*COS(Q6)*COS(Q5)*
     &*2*U1**2-IYB*(SIN(Q4)*COS(Q6)+SIN(Q5)*SIN(Q6)*COS(Q4))*U3*U4-IYB*(
     &SIN(Q6)*COS(Q4)+SIN(Q4)*SIN(Q5)*COS(Q6))*U2*U5-IYB*(SIN(Q4)*SIN(Q6
     &)-SIN(Q5)*COS(Q4)*COS(Q6))*U3*U5-IYB*(COS(Q4)*COS(Q6)-SIN(Q4)*SIN(
     &Q5)*SIN(Q6))*U2*U4-IXB*SIN(Q6)*COS(Q5)*(SIN(Q6)*COS(Q4)+SIN(Q4)*SI
     &N(Q5)*COS(Q6))*U1*U2-IYB*COS(Q5)*COS(Q6)*(SIN(Q4)*COS(Q6)+SIN(Q5)*
     &SIN(Q6)*COS(Q4))*U1*U3-IXB*SIN(Q6)*COS(Q5)*(SIN(Q4)*SIN(Q6)-SIN(Q5
     &)*COS(Q4)*COS(Q6))*U1*U3-IYB*COS(Q5)*COS(Q6)*(COS(Q4)*COS(Q6)-SIN(
     &Q4)*SIN(Q5)*SIN(Q6))*U1*U2-IYB*(SIN(Q4)*COS(Q6)+SIN(Q5)*SIN(Q6)*CO
     &S(Q4))*(SIN(Q6)*COS(Q4)+SIN(Q4)*SIN(Q5)*COS(Q6))*U2*U3-IYB*(SIN(Q4
     &)*COS(Q6)+SIN(Q5)*SIN(Q6)*COS(Q4))*(SIN(Q4)*SIN(Q6)-SIN(Q5)*COS(Q4
     &)*COS(Q6))*U3**2-IYB*(SIN(Q6)*COS(Q4)+SIN(Q4)*SIN(Q5)*COS(Q6))*(CO
     &S(Q4)*COS(Q6)-SIN(Q4)*SIN(Q5)*SIN(Q6))*U2**2-IYB*(SIN(Q4)*SIN(Q6)-
     &SIN(Q5)*COS(Q4)*COS(Q6))*(COS(Q4)*COS(Q6)-SIN(Q4)*SIN(Q5)*SIN(Q6))
     &*U2*U3)
      RHS(2) = KA*Q2 + G*LAO*MA*COS(Q1)*COS(Q2) + G*MB*(LA*COS(Q1)*COS(Q
     &2)+LBO*(COS(Q4)*COS(Q6)-SIN(Q4)*SIN(Q5)*SIN(Q6))*(COS(Q1)*COS(Q2)*
     &COS(Q4)*COS(Q5)+SIN(Q5)*(SIN(Q1)*SIN(Q3)-SIN(Q2)*COS(Q1)*COS(Q3))-
     &SIN(Q4)*COS(Q5)*(SIN(Q1)*COS(Q3)+SIN(Q2)*SIN(Q3)*COS(Q1)))-LBO*SIN
     &(Q4)*COS(Q5)*(SIN(Q6)*COS(Q5)*(SIN(Q1)*SIN(Q3)-SIN(Q2)*COS(Q1)*COS
     &(Q3))-COS(Q1)*COS(Q2)*(SIN(Q4)*COS(Q6)+SIN(Q5)*SIN(Q6)*COS(Q4))-(S
     &IN(Q1)*COS(Q3)+SIN(Q2)*SIN(Q3)*COS(Q1))*(COS(Q4)*COS(Q6)-SIN(Q4)*S
     &IN(Q5)*SIN(Q6)))) + BA*U2 + (IXA-IZA)*U1*U3 + LAO*MA*(PYpp*SIN(Q1)
     &*COS(Q2)-PXpp*SIN(Q2)-PZpp*COS(Q1)*COS(Q2)-LAO*U1*U3) + IXB*(SIN(Q
     &6)*COS(Q4)+SIN(Q4)*SIN(Q5)*COS(Q6))*(U5*(SIN(Q4)*COS(Q5)*U2-U6-SIN
     &(Q5)*U1-COS(Q4)*COS(Q5)*U3)-U6*(SIN(Q6)*COS(Q5)*U1-U5-(SIN(Q4)*COS
     &(Q6)+SIN(Q5)*SIN(Q6)*COS(Q4))*U3-(COS(Q4)*COS(Q6)-SIN(Q4)*SIN(Q5)*
     &SIN(Q6))*U2)) + (COS(Q4)*COS(Q6)-SIN(Q4)*SIN(Q5)*SIN(Q6))*(IXB*U4*
     &U6+IXB*SIN(Q5)*U1*U4+IXB*COS(Q4)*COS(Q5)*U3*U4+IXB*COS(Q5)*COS(Q6)
     &*U1*U6+IZB*SIN(Q4)*COS(Q5)*U2*U4+IXB*SIN(Q5)*COS(Q5)*COS(Q6)*U1**2
     &+IXB*COS(Q4)*COS(Q6)*COS(Q5)**2*U1*U3+IZB*SIN(Q4)*COS(Q6)*COS(Q5)*
     &*2*U1*U2+IXB*(SIN(Q6)*COS(Q4)+SIN(Q4)*SIN(Q5)*COS(Q6))*U2*U6+IXB*(
     &SIN(Q4)*SIN(Q6)-SIN(Q5)*COS(Q4)*COS(Q6))*U3*U6+IXB*SIN(Q5)*(SIN(Q6
     &)*COS(Q4)+SIN(Q4)*SIN(Q5)*COS(Q6))*U1*U2+IXB*SIN(Q5)*(SIN(Q4)*SIN(
     &Q6)-SIN(Q5)*COS(Q4)*COS(Q6))*U1*U3+IXB*COS(Q4)*COS(Q5)*(SIN(Q6)*CO
     &S(Q4)+SIN(Q4)*SIN(Q5)*COS(Q6))*U2*U3+IZB*SIN(Q4)*COS(Q5)*(SIN(Q6)*
     &COS(Q4)+SIN(Q4)*SIN(Q5)*COS(Q6))*U2**2+IXB*COS(Q4)*COS(Q5)*(SIN(Q4
     &)*SIN(Q6)-SIN(Q5)*COS(Q4)*COS(Q6))*U3**2+IZB*SIN(Q4)*COS(Q5)*(SIN(
     &Q4)*SIN(Q6)-SIN(Q5)*COS(Q4)*COS(Q6))*U2*U3-IZB*U4*U6-IZB*SIN(Q5)*U
     &1*U4-IXB*SIN(Q4)*COS(Q5)*U2*U4-IZB*COS(Q4)*COS(Q5)*U3*U4-IZB*COS(Q
     &5)*COS(Q6)*U1*U6-IZB*SIN(Q5)*COS(Q5)*COS(Q6)*U1**2-IXB*SIN(Q4)*COS
     &(Q6)*COS(Q5)**2*U1*U2-IZB*COS(Q4)*COS(Q6)*COS(Q5)**2*U1*U3-IZB*(SI
     &N(Q6)*COS(Q4)+SIN(Q4)*SIN(Q5)*COS(Q6))*U2*U6-IZB*(SIN(Q4)*SIN(Q6)-
     &SIN(Q5)*COS(Q4)*COS(Q6))*U3*U6-IZB*SIN(Q5)*(SIN(Q6)*COS(Q4)+SIN(Q4
     &)*SIN(Q5)*COS(Q6))*U1*U2-IZB*SIN(Q5)*(SIN(Q4)*SIN(Q6)-SIN(Q5)*COS(
     &Q4)*COS(Q6))*U1*U3-IXB*SIN(Q4)*COS(Q5)*(SIN(Q6)*COS(Q4)+SIN(Q4)*SI
     &N(Q5)*COS(Q6))*U2**2-IZB*COS(Q4)*COS(Q5)*(SIN(Q6)*COS(Q4)+SIN(Q4)*
     &SIN(Q5)*COS(Q6))*U2*U3-IXB*SIN(Q4)*COS(Q5)*(SIN(Q4)*SIN(Q6)-SIN(Q5
     &)*COS(Q4)*COS(Q6))*U2*U3-IZB*COS(Q4)*COS(Q5)*(SIN(Q4)*SIN(Q6)-SIN(
     &Q5)*COS(Q4)*COS(Q6))*U3**2) + SIN(Q4)*COS(Q5)*(IXB*U4*U5+IXB*COS(Q
     &5)*COS(Q6)*U1*U5+IYB*SIN(Q6)*COS(Q5)*U1*U4+IYB*SIN(Q6)*COS(Q6)*COS
     &(Q5)**2*U1**2+IXB*(SIN(Q4)*COS(Q6)+SIN(Q5)*SIN(Q6)*COS(Q4))*U3*U4+
     &IXB*(SIN(Q6)*COS(Q4)+SIN(Q4)*SIN(Q5)*COS(Q6))*U2*U5+IXB*(SIN(Q4)*S
     &IN(Q6)-SIN(Q5)*COS(Q4)*COS(Q6))*U3*U5+IXB*(COS(Q4)*COS(Q6)-SIN(Q4)
     &*SIN(Q5)*SIN(Q6))*U2*U4+IXB*COS(Q5)*COS(Q6)*(SIN(Q4)*COS(Q6)+SIN(Q
     &5)*SIN(Q6)*COS(Q4))*U1*U3+IYB*SIN(Q6)*COS(Q5)*(SIN(Q6)*COS(Q4)+SIN
     &(Q4)*SIN(Q5)*COS(Q6))*U1*U2+IXB*COS(Q5)*COS(Q6)*(COS(Q4)*COS(Q6)-S
     &IN(Q4)*SIN(Q5)*SIN(Q6))*U1*U2+IYB*SIN(Q6)*COS(Q5)*(SIN(Q4)*SIN(Q6)
     &-SIN(Q5)*COS(Q4)*COS(Q6))*U1*U3+IXB*(SIN(Q4)*COS(Q6)+SIN(Q5)*SIN(Q
     &6)*COS(Q4))*(SIN(Q6)*COS(Q4)+SIN(Q4)*SIN(Q5)*COS(Q6))*U2*U3+IXB*(S
     &IN(Q4)*COS(Q6)+SIN(Q5)*SIN(Q6)*COS(Q4))*(SIN(Q4)*SIN(Q6)-SIN(Q5)*C
     &OS(Q4)*COS(Q6))*U3**2+IXB*(SIN(Q6)*COS(Q4)+SIN(Q4)*SIN(Q5)*COS(Q6)
     &)*(COS(Q4)*COS(Q6)-SIN(Q4)*SIN(Q5)*SIN(Q6))*U2**2+IXB*(SIN(Q4)*SIN
     &(Q6)-SIN(Q5)*COS(Q4)*COS(Q6))*(COS(Q4)*COS(Q6)-SIN(Q4)*SIN(Q5)*SIN
     &(Q6))*U2*U3-IYB*U4*U5-IXB*SIN(Q6)*COS(Q5)*U1*U4-IYB*COS(Q5)*COS(Q6
     &)*U1*U5-IXB*SIN(Q6)*COS(Q6)*COS(Q5)**2*U1**2-IYB*(SIN(Q4)*COS(Q6)+
     &SIN(Q5)*SIN(Q6)*COS(Q4))*U3*U4-IYB*(SIN(Q6)*COS(Q4)+SIN(Q4)*SIN(Q5
     &)*COS(Q6))*U2*U5-IYB*(SIN(Q4)*SIN(Q6)-SIN(Q5)*COS(Q4)*COS(Q6))*U3*
     &U5-IYB*(COS(Q4)*COS(Q6)-SIN(Q4)*SIN(Q5)*SIN(Q6))*U2*U4-IXB*SIN(Q6)
     &*COS(Q5)*(SIN(Q6)*COS(Q4)+SIN(Q4)*SIN(Q5)*COS(Q6))*U1*U2-IYB*COS(Q
     &5)*COS(Q6)*(SIN(Q4)*COS(Q6)+SIN(Q5)*SIN(Q6)*COS(Q4))*U1*U3-IXB*SIN
     &(Q6)*COS(Q5)*(SIN(Q4)*SIN(Q6)-SIN(Q5)*COS(Q4)*COS(Q6))*U1*U3-IYB*C
     &OS(Q5)*COS(Q6)*(COS(Q4)*COS(Q6)-SIN(Q4)*SIN(Q5)*SIN(Q6))*U1*U2-IYB
     &*(SIN(Q4)*COS(Q6)+SIN(Q5)*SIN(Q6)*COS(Q4))*(SIN(Q6)*COS(Q4)+SIN(Q4
     &)*SIN(Q5)*COS(Q6))*U2*U3-IYB*(SIN(Q4)*COS(Q6)+SIN(Q5)*SIN(Q6)*COS(
     &Q4))*(SIN(Q4)*SIN(Q6)-SIN(Q5)*COS(Q4)*COS(Q6))*U3**2-IYB*(SIN(Q6)*
     &COS(Q4)+SIN(Q4)*SIN(Q5)*COS(Q6))*(COS(Q4)*COS(Q6)-SIN(Q4)*SIN(Q5)*
     &SIN(Q6))*U2**2-IYB*(SIN(Q4)*SIN(Q6)-SIN(Q5)*COS(Q4)*COS(Q6))*(COS(
     &Q4)*COS(Q6)-SIN(Q4)*SIN(Q5)*SIN(Q6))*U2*U3) - IYB*(COS(Q4)*COS(Q6)
     &-SIN(Q4)*SIN(Q5)*SIN(Q6))*(U4*(SIN(Q4)*COS(Q5)*U2-U6-SIN(Q5)*U1-CO
     &S(Q4)*COS(Q5)*U3)+U6*(U4+COS(Q5)*COS(Q6)*U1+(SIN(Q6)*COS(Q4)+SIN(Q
     &4)*SIN(Q5)*COS(Q6))*U2+(SIN(Q4)*SIN(Q6)-SIN(Q5)*COS(Q4)*COS(Q6))*U
     &3)) - IZB*SIN(Q4)*COS(Q5)*(U5*(U4+COS(Q5)*COS(Q6)*U1+(SIN(Q6)*COS(
     &Q4)+SIN(Q4)*SIN(Q5)*COS(Q6))*U2+(SIN(Q4)*SIN(Q6)-SIN(Q5)*COS(Q4)*C
     &OS(Q6))*U3)+U4*(SIN(Q6)*COS(Q5)*U1-U5-(SIN(Q4)*COS(Q6)+SIN(Q5)*SIN
     &(Q6)*COS(Q4))*U3-(COS(Q4)*COS(Q6)-SIN(Q4)*SIN(Q5)*SIN(Q6))*U2)) - 
     &(SIN(Q6)*COS(Q4)+SIN(Q4)*SIN(Q5)*COS(Q6))*(IYB*U5*U6+IYB*SIN(Q5)*U
     &1*U5+IYB*COS(Q4)*COS(Q5)*U3*U5+IZB*SIN(Q4)*COS(Q5)*U2*U5+IZB*SIN(Q
     &6)*COS(Q5)*U1*U6+IZB*SIN(Q5)*SIN(Q6)*COS(Q5)*U1**2+IYB*SIN(Q4)*SIN
     &(Q6)*COS(Q5)**2*U1*U2+IZB*SIN(Q6)*COS(Q4)*COS(Q5)**2*U1*U3+IYB*(SI
     &N(Q4)*COS(Q6)+SIN(Q5)*SIN(Q6)*COS(Q4))*U3*U6+IYB*(COS(Q4)*COS(Q6)-
     &SIN(Q4)*SIN(Q5)*SIN(Q6))*U2*U6+IYB*SIN(Q5)*(SIN(Q4)*COS(Q6)+SIN(Q5
     &)*SIN(Q6)*COS(Q4))*U1*U3+IYB*SIN(Q5)*(COS(Q4)*COS(Q6)-SIN(Q4)*SIN(
     &Q5)*SIN(Q6))*U1*U2+IYB*COS(Q4)*COS(Q5)*(SIN(Q4)*COS(Q6)+SIN(Q5)*SI
     &N(Q6)*COS(Q4))*U3**2+IZB*SIN(Q4)*COS(Q5)*(SIN(Q4)*COS(Q6)+SIN(Q5)*
     &SIN(Q6)*COS(Q4))*U2*U3+IYB*COS(Q4)*COS(Q5)*(COS(Q4)*COS(Q6)-SIN(Q4
     &)*SIN(Q5)*SIN(Q6))*U2*U3+IZB*SIN(Q4)*COS(Q5)*(COS(Q4)*COS(Q6)-SIN(
     &Q4)*SIN(Q5)*SIN(Q6))*U2**2-IZB*U5*U6-IZB*SIN(Q5)*U1*U5-IYB*SIN(Q4)
     &*COS(Q5)*U2*U5-IYB*SIN(Q6)*COS(Q5)*U1*U6-IZB*COS(Q4)*COS(Q5)*U3*U5
     &-IYB*SIN(Q5)*SIN(Q6)*COS(Q5)*U1**2-IYB*SIN(Q6)*COS(Q4)*COS(Q5)**2*
     &U1*U3-IZB*SIN(Q4)*SIN(Q6)*COS(Q5)**2*U1*U2-IZB*(SIN(Q4)*COS(Q6)+SI
     &N(Q5)*SIN(Q6)*COS(Q4))*U3*U6-IZB*(COS(Q4)*COS(Q6)-SIN(Q4)*SIN(Q5)*
     &SIN(Q6))*U2*U6-IZB*SIN(Q5)*(SIN(Q4)*COS(Q6)+SIN(Q5)*SIN(Q6)*COS(Q4
     &))*U1*U3-IZB*SIN(Q5)*(COS(Q4)*COS(Q6)-SIN(Q4)*SIN(Q5)*SIN(Q6))*U1*
     &U2-IYB*SIN(Q4)*COS(Q5)*(SIN(Q4)*COS(Q6)+SIN(Q5)*SIN(Q6)*COS(Q4))*U
     &2*U3-IZB*COS(Q4)*COS(Q5)*(SIN(Q4)*COS(Q6)+SIN(Q5)*SIN(Q6)*COS(Q4))
     &*U3**2-IYB*SIN(Q4)*COS(Q5)*(COS(Q4)*COS(Q6)-SIN(Q4)*SIN(Q5)*SIN(Q6
     &))*U2**2-IZB*COS(Q4)*COS(Q5)*(COS(Q4)*COS(Q6)-SIN(Q4)*SIN(Q5)*SIN(
     &Q6))*U2*U3) - MB*(LA*PXpp*SIN(Q2)+LA*PZpp*COS(Q1)*COS(Q2)+LBO*PXpp
     &*(COS(Q4)*COS(Q6)-SIN(Q4)*SIN(Q5)*SIN(Q6))*(SIN(Q2)*COS(Q4)*COS(Q5
     &)+SIN(Q5)*COS(Q2)*COS(Q3)+SIN(Q3)*SIN(Q4)*COS(Q2)*COS(Q5))+LBO*PXp
     &p*SIN(Q4)*COS(Q5)*(SIN(Q2)*(SIN(Q4)*COS(Q6)+SIN(Q5)*SIN(Q6)*COS(Q4
     &))-SIN(Q6)*COS(Q2)*COS(Q3)*COS(Q5)-SIN(Q3)*COS(Q2)*(COS(Q4)*COS(Q6
     &)-SIN(Q4)*SIN(Q5)*SIN(Q6)))+LBO*PZpp*(COS(Q4)*COS(Q6)-SIN(Q4)*SIN(
     &Q5)*SIN(Q6))*(COS(Q1)*COS(Q2)*COS(Q4)*COS(Q5)+SIN(Q5)*(SIN(Q1)*SIN
     &(Q3)-SIN(Q2)*COS(Q1)*COS(Q3))-SIN(Q4)*COS(Q5)*(SIN(Q1)*COS(Q3)+SIN
     &(Q2)*SIN(Q3)*COS(Q1)))+LBO*PYpp*(COS(Q4)*COS(Q6)-SIN(Q4)*SIN(Q5)*S
     &IN(Q6))*(SIN(Q5)*(SIN(Q3)*COS(Q1)+SIN(Q1)*SIN(Q2)*COS(Q3))-SIN(Q1)
     &*COS(Q2)*COS(Q4)*COS(Q5)-SIN(Q4)*COS(Q5)*(COS(Q1)*COS(Q3)-SIN(Q1)*
     &SIN(Q2)*SIN(Q3)))+LA**2*U1*U3+LA*LBO*SIN(Q4)*SIN(Q6)*COS(Q5)**2*(U
     &2**2+U3**2)+LA*LBO*SIN(Q4)*COS(Q5)*(SIN(Q4)*COS(Q6)+SIN(Q5)*SIN(Q6
     &)*COS(Q4))*U1*U3+LA*LBO*COS(Q4)*COS(Q5)*(COS(Q4)*COS(Q6)-SIN(Q4)*S
     &IN(Q5)*SIN(Q6))*U1*U3+LBO**2*SIN(Q4)*COS(Q5)*(COS(Q5)*U1*Q5p+SIN(Q
     &4)*SIN(Q5)*U2*Q5p-(U4+COS(Q5)*COS(Q6)*U1+(SIN(Q6)*COS(Q4)+SIN(Q4)*
     &SIN(Q5)*COS(Q6))*U2+(SIN(Q4)*SIN(Q6)-SIN(Q5)*COS(Q4)*COS(Q6))*U3)*
     &(SIN(Q6)*COS(Q5)*U1-U5-(SIN(Q4)*COS(Q6)+SIN(Q5)*SIN(Q6)*COS(Q4))*U
     &3-(COS(Q4)*COS(Q6)-SIN(Q4)*SIN(Q5)*SIN(Q6))*U2)-SIN(Q4)*COS(Q5)*U3
     &*Q4p-SIN(Q5)*COS(Q4)*U3*Q5p-COS(Q4)*COS(Q5)*U2*Q4p)+LA*LBO*(SIN(Q4
     &)*COS(Q6)+SIN(Q5)*SIN(Q6)*COS(Q4))*(COS(Q5)*U1*Q5p+SIN(Q4)*SIN(Q5)
     ...
     &5)*COS(Q4)*U3*Q5p-COS(Q4)*COS(Q5)*U2*Q4p)-LA*PYpp*SIN(Q1)*COS(Q2)-
     &LBO*PYpp*SIN(Q4)*COS(Q5)*(SIN(Q1)*COS(Q2)*(SIN(Q4)*COS(Q6)+SIN(Q5)
     &*SIN(Q6)*COS(Q4))+SIN(Q6)*COS(Q5)*(SIN(Q3)*COS(Q1)+SIN(Q1)*SIN(Q2)
     &*COS(Q3))-(COS(Q1)*COS(Q3)-SIN(Q1)*SIN(Q2)*SIN(Q3))*(COS(Q4)*COS(Q
     &6)-SIN(Q4)*SIN(Q5)*SIN(Q6)))-LBO*PZpp*SIN(Q4)*COS(Q5)*(SIN(Q6)*COS
     &(Q5)*(SIN(Q1)*SIN(Q3)-SIN(Q2)*COS(Q1)*COS(Q3))-COS(Q1)*COS(Q2)*(SI
     &N(Q4)*COS(Q6)+SIN(Q5)*SIN(Q6)*COS(Q4))-(SIN(Q1)*COS(Q3)+SIN(Q2)*SI
     &N(Q3)*COS(Q1))*(COS(Q4)*COS(Q6)-SIN(Q4)*SIN(Q5)*SIN(Q6)))-LA*LBO*S
     &IN(Q5)*(COS(Q4)*COS(Q6)-SIN(Q4)*SIN(Q5)*SIN(Q6))*(U2**2+U3**2)-LA*
     &LBO*(SIN(Q4)*SIN(Q6)-SIN(Q5)*COS(Q4)*COS(Q6))*((SIN(Q4)*COS(Q5)*U2
     &-U6-SIN(Q5)*U1-COS(Q4)*COS(Q5)*U3)**2+(SIN(Q6)*COS(Q5)*U1-U5-(SIN(
     &Q4)*COS(Q6)+SIN(Q5)*SIN(Q6)*COS(Q4))*U3-(COS(Q4)*COS(Q6)-SIN(Q4)*S
     &IN(Q5)*SIN(Q6))*U2)**2)-LA*LBO*COS(Q4)*COS(Q5)*((SIN(Q4)*COS(Q5)*U
     &2-U6-SIN(Q5)*U1-COS(Q4)*COS(Q5)*U3)*(U4+COS(Q5)*COS(Q6)*U1+(SIN(Q6
     &)*COS(Q4)+SIN(Q4)*SIN(Q5)*COS(Q6))*U2+(SIN(Q4)*SIN(Q6)-SIN(Q5)*COS
     &(Q4)*COS(Q6))*U3)+SIN(Q5)*SIN(Q6)*U1*Q5p-COS(Q5)*COS(Q6)*U1*Q6p-U2
     &*(SIN(Q4)*COS(Q6)*Q4p+SIN(Q6)*COS(Q4)*Q6p+SIN(Q4)*SIN(Q5)*COS(Q6)*
     &Q6p+SIN(Q4)*SIN(Q6)*COS(Q5)*Q5p+SIN(Q5)*SIN(Q6)*COS(Q4)*Q4p)-U3*(S
     &IN(Q4)*SIN(Q6)*Q6p+SIN(Q4)*SIN(Q5)*SIN(Q6)*Q4p-COS(Q4)*COS(Q6)*Q4p
     &-SIN(Q5)*COS(Q4)*COS(Q6)*Q6p-SIN(Q6)*COS(Q4)*COS(Q5)*Q5p))-LBO**2*
     &(COS(Q4)*COS(Q6)-SIN(Q4)*SIN(Q5)*SIN(Q6))*((SIN(Q4)*COS(Q5)*U2-U6-
     &SIN(Q5)*U1-COS(Q4)*COS(Q5)*U3)*(U4+COS(Q5)*COS(Q6)*U1+(SIN(Q6)*COS
     &(Q4)+SIN(Q4)*SIN(Q5)*COS(Q6))*U2+(SIN(Q4)*SIN(Q6)-SIN(Q5)*COS(Q4)*
     &COS(Q6))*U3)+SIN(Q5)*SIN(Q6)*U1*Q5p-COS(Q5)*COS(Q6)*U1*Q6p-U2*(SIN
     &(Q4)*COS(Q6)*Q4p+SIN(Q6)*COS(Q4)*Q6p+SIN(Q4)*SIN(Q5)*COS(Q6)*Q6p+S
     &IN(Q4)*SIN(Q6)*COS(Q5)*Q5p+SIN(Q5)*SIN(Q6)*COS(Q4)*Q4p)-U3*(SIN(Q4
     &)*SIN(Q6)*Q6p+SIN(Q4)*SIN(Q5)*SIN(Q6)*Q4p-COS(Q4)*COS(Q6)*Q4p-SIN(
     &Q5)*COS(Q4)*COS(Q6)*Q6p-SIN(Q6)*COS(Q4)*COS(Q5)*Q5p)))
      RHS(3) = KA*Q3 + BA*U3 + IXB*(SIN(Q4)*SIN(Q6)-SIN(Q5)*COS(Q4)*COS(
     &Q6))*(U5*(SIN(Q4)*COS(Q5)*U2-U6-SIN(Q5)*U1-COS(Q4)*COS(Q5)*U3)-U6*
     &(SIN(Q6)*COS(Q5)*U1-U5-(SIN(Q4)*COS(Q6)+SIN(Q5)*SIN(Q6)*COS(Q4))*U
     &3-(COS(Q4)*COS(Q6)-SIN(Q4)*SIN(Q5)*SIN(Q6))*U2)) + IZB*COS(Q4)*COS
     &(Q5)*(U5*(U4+COS(Q5)*COS(Q6)*U1+(SIN(Q6)*COS(Q4)+SIN(Q4)*SIN(Q5)*C
     &OS(Q6))*U2+(SIN(Q4)*SIN(Q6)-SIN(Q5)*COS(Q4)*COS(Q6))*U3)+U4*(SIN(Q
     &6)*COS(Q5)*U1-U5-(SIN(Q4)*COS(Q6)+SIN(Q5)*SIN(Q6)*COS(Q4))*U3-(COS
     &(Q4)*COS(Q6)-SIN(Q4)*SIN(Q5)*SIN(Q6))*U2)) + (SIN(Q4)*COS(Q6)+SIN(
     &Q5)*SIN(Q6)*COS(Q4))*(IXB*U4*U6+IXB*SIN(Q5)*U1*U4+IXB*COS(Q4)*COS(
     &Q5)*U3*U4+IXB*COS(Q5)*COS(Q6)*U1*U6+IZB*SIN(Q4)*COS(Q5)*U2*U4+IXB*
     &SIN(Q5)*COS(Q5)*COS(Q6)*U1**2+IXB*COS(Q4)*COS(Q6)*COS(Q5)**2*U1*U3
     &+IZB*SIN(Q4)*COS(Q6)*COS(Q5)**2*U1*U2+IXB*(SIN(Q6)*COS(Q4)+SIN(Q4)
     &*SIN(Q5)*COS(Q6))*U2*U6+IXB*(SIN(Q4)*SIN(Q6)-SIN(Q5)*COS(Q4)*COS(Q
     &6))*U3*U6+IXB*SIN(Q5)*(SIN(Q6)*COS(Q4)+SIN(Q4)*SIN(Q5)*COS(Q6))*U1
     &*U2+IXB*SIN(Q5)*(SIN(Q4)*SIN(Q6)-SIN(Q5)*COS(Q4)*COS(Q6))*U1*U3+IX
     &B*COS(Q4)*COS(Q5)*(SIN(Q6)*COS(Q4)+SIN(Q4)*SIN(Q5)*COS(Q6))*U2*U3+
     &IZB*SIN(Q4)*COS(Q5)*(SIN(Q6)*COS(Q4)+SIN(Q4)*SIN(Q5)*COS(Q6))*U2**
     &2+IXB*COS(Q4)*COS(Q5)*(SIN(Q4)*SIN(Q6)-SIN(Q5)*COS(Q4)*COS(Q6))*U3
     &**2+IZB*SIN(Q4)*COS(Q5)*(SIN(Q4)*SIN(Q6)-SIN(Q5)*COS(Q4)*COS(Q6))*
     &U2*U3-IZB*U4*U6-IZB*SIN(Q5)*U1*U4-IXB*SIN(Q4)*COS(Q5)*U2*U4-IZB*CO
     &S(Q4)*COS(Q5)*U3*U4-IZB*COS(Q5)*COS(Q6)*U1*U6-IZB*SIN(Q5)*COS(Q5)*
     &COS(Q6)*U1**2-IXB*SIN(Q4)*COS(Q6)*COS(Q5)**2*U1*U2-IZB*COS(Q4)*COS
     &(Q6)*COS(Q5)**2*U1*U3-IZB*(SIN(Q6)*COS(Q4)+SIN(Q4)*SIN(Q5)*COS(Q6)
     &)*U2*U6-IZB*(SIN(Q4)*SIN(Q6)-SIN(Q5)*COS(Q4)*COS(Q6))*U3*U6-IZB*SI
     &N(Q5)*(SIN(Q6)*COS(Q4)+SIN(Q4)*SIN(Q5)*COS(Q6))*U1*U2-IZB*SIN(Q5)*
     &(SIN(Q4)*SIN(Q6)-SIN(Q5)*COS(Q4)*COS(Q6))*U1*U3-IXB*SIN(Q4)*COS(Q5
     &)*(SIN(Q6)*COS(Q4)+SIN(Q4)*SIN(Q5)*COS(Q6))*U2**2-IZB*COS(Q4)*COS(
     &Q5)*(SIN(Q6)*COS(Q4)+SIN(Q4)*SIN(Q5)*COS(Q6))*U2*U3-IXB*SIN(Q4)*CO
     &S(Q5)*(SIN(Q4)*SIN(Q6)-SIN(Q5)*COS(Q4)*COS(Q6))*U2*U3-IZB*COS(Q4)*
     &COS(Q5)*(SIN(Q4)*SIN(Q6)-SIN(Q5)*COS(Q4)*COS(Q6))*U3**2) - G*LAO*M
     &A*(SIN(Q1)*COS(Q3)+SIN(Q2)*SIN(Q3)*COS(Q1)) - G*MB*(LA*(SIN(Q1)*CO
     &S(Q3)+SIN(Q2)*SIN(Q3)*COS(Q1))-LBO*(SIN(Q4)*COS(Q6)+SIN(Q5)*SIN(Q6
     &)*COS(Q4))*(COS(Q1)*COS(Q2)*COS(Q4)*COS(Q5)+SIN(Q5)*(SIN(Q1)*SIN(Q
     &3)-SIN(Q2)*COS(Q1)*COS(Q3))-SIN(Q4)*COS(Q5)*(SIN(Q1)*COS(Q3)+SIN(Q
     &2)*SIN(Q3)*COS(Q1)))-LBO*COS(Q4)*COS(Q5)*(SIN(Q6)*COS(Q5)*(SIN(Q1)
     &*SIN(Q3)-SIN(Q2)*COS(Q1)*COS(Q3))-COS(Q1)*COS(Q2)*(SIN(Q4)*COS(Q6)
     &+SIN(Q5)*SIN(Q6)*COS(Q4))-(SIN(Q1)*COS(Q3)+SIN(Q2)*SIN(Q3)*COS(Q1)
     &)*(COS(Q4)*COS(Q6)-SIN(Q4)*SIN(Q5)*SIN(Q6)))) - (IXA-IYA)*U1*U2 - 
     &LAO*MA*(PXpp*SIN(Q3)*COS(Q2)-PZpp*(SIN(Q1)*COS(Q3)+SIN(Q2)*SIN(Q3)
     &*COS(Q1))-PYpp*(COS(Q1)*COS(Q3)-SIN(Q1)*SIN(Q2)*SIN(Q3))-LAO*U1*U2
     &) - IYB*(SIN(Q4)*COS(Q6)+SIN(Q5)*SIN(Q6)*COS(Q4))*(U4*(SIN(Q4)*COS
     &(Q5)*U2-U6-SIN(Q5)*U1-COS(Q4)*COS(Q5)*U3)+U6*(U4+COS(Q5)*COS(Q6)*U
     &1+(SIN(Q6)*COS(Q4)+SIN(Q4)*SIN(Q5)*COS(Q6))*U2+(SIN(Q4)*SIN(Q6)-SI
     &N(Q5)*COS(Q4)*COS(Q6))*U3)) - (SIN(Q4)*SIN(Q6)-SIN(Q5)*COS(Q4)*COS
     &(Q6))*(IYB*U5*U6+IYB*SIN(Q5)*U1*U5+IYB*COS(Q4)*COS(Q5)*U3*U5+IZB*S
     &IN(Q4)*COS(Q5)*U2*U5+IZB*SIN(Q6)*COS(Q5)*U1*U6+IZB*SIN(Q5)*SIN(Q6)
     &*COS(Q5)*U1**2+IYB*SIN(Q4)*SIN(Q6)*COS(Q5)**2*U1*U2+IZB*SIN(Q6)*CO
     &S(Q4)*COS(Q5)**2*U1*U3+IYB*(SIN(Q4)*COS(Q6)+SIN(Q5)*SIN(Q6)*COS(Q4
     &))*U3*U6+IYB*(COS(Q4)*COS(Q6)-SIN(Q4)*SIN(Q5)*SIN(Q6))*U2*U6+IYB*S
     &IN(Q5)*(SIN(Q4)*COS(Q6)+SIN(Q5)*SIN(Q6)*COS(Q4))*U1*U3+IYB*SIN(Q5)
     &*(COS(Q4)*COS(Q6)-SIN(Q4)*SIN(Q5)*SIN(Q6))*U1*U2+IYB*COS(Q4)*COS(Q
     &5)*(SIN(Q4)*COS(Q6)+SIN(Q5)*SIN(Q6)*COS(Q4))*U3**2+IZB*SIN(Q4)*COS
     &(Q5)*(SIN(Q4)*COS(Q6)+SIN(Q5)*SIN(Q6)*COS(Q4))*U2*U3+IYB*COS(Q4)*C
     &OS(Q5)*(COS(Q4)*COS(Q6)-SIN(Q4)*SIN(Q5)*SIN(Q6))*U2*U3+IZB*SIN(Q4)
     &*COS(Q5)*(COS(Q4)*COS(Q6)-SIN(Q4)*SIN(Q5)*SIN(Q6))*U2**2-IZB*U5*U6
     &-IZB*SIN(Q5)*U1*U5-IYB*SIN(Q4)*COS(Q5)*U2*U5-IYB*SIN(Q6)*COS(Q5)*U
     &1*U6-IZB*COS(Q4)*COS(Q5)*U3*U5-IYB*SIN(Q5)*SIN(Q6)*COS(Q5)*U1**2-I
     &YB*SIN(Q6)*COS(Q4)*COS(Q5)**2*U1*U3-IZB*SIN(Q4)*SIN(Q6)*COS(Q5)**2
     &*U1*U2-IZB*(SIN(Q4)*COS(Q6)+SIN(Q5)*SIN(Q6)*COS(Q4))*U3*U6-IZB*(CO
     &S(Q4)*COS(Q6)-SIN(Q4)*SIN(Q5)*SIN(Q6))*U2*U6-IZB*SIN(Q5)*(SIN(Q4)*
     &COS(Q6)+SIN(Q5)*SIN(Q6)*COS(Q4))*U1*U3-IZB*SIN(Q5)*(COS(Q4)*COS(Q6
     &)-SIN(Q4)*SIN(Q5)*SIN(Q6))*U1*U2-IYB*SIN(Q4)*COS(Q5)*(SIN(Q4)*COS(
     &Q6)+SIN(Q5)*SIN(Q6)*COS(Q4))*U2*U3-IZB*COS(Q4)*COS(Q5)*(SIN(Q4)*CO
     &S(Q6)+SIN(Q5)*SIN(Q6)*COS(Q4))*U3**2-IYB*SIN(Q4)*COS(Q5)*(COS(Q4)*
     &COS(Q6)-SIN(Q4)*SIN(Q5)*SIN(Q6))*U2**2-IZB*COS(Q4)*COS(Q5)*(COS(Q4
     &)*COS(Q6)-SIN(Q4)*SIN(Q5)*SIN(Q6))*U2*U3) - COS(Q4)*COS(Q5)*(IXB*U
     &4*U5+IXB*COS(Q5)*COS(Q6)*U1*U5+IYB*SIN(Q6)*COS(Q5)*U1*U4+IYB*SIN(Q
     &6)*COS(Q6)*COS(Q5)**2*U1**2+IXB*(SIN(Q4)*COS(Q6)+SIN(Q5)*SIN(Q6)*C
     &OS(Q4))*U3*U4+IXB*(SIN(Q6)*COS(Q4)+SIN(Q4)*SIN(Q5)*COS(Q6))*U2*U5+
     &IXB*(SIN(Q4)*SIN(Q6)-SIN(Q5)*COS(Q4)*COS(Q6))*U3*U5+IXB*(COS(Q4)*C
     &OS(Q6)-SIN(Q4)*SIN(Q5)*SIN(Q6))*U2*U4+IXB*COS(Q5)*COS(Q6)*(SIN(Q4)
     &*COS(Q6)+SIN(Q5)*SIN(Q6)*COS(Q4))*U1*U3+IYB*SIN(Q6)*COS(Q5)*(SIN(Q
     &6)*COS(Q4)+SIN(Q4)*SIN(Q5)*COS(Q6))*U1*U2+IXB*COS(Q5)*COS(Q6)*(COS
     &(Q4)*COS(Q6)-SIN(Q4)*SIN(Q5)*SIN(Q6))*U1*U2+IYB*SIN(Q6)*COS(Q5)*(S
     &IN(Q4)*SIN(Q6)-SIN(Q5)*COS(Q4)*COS(Q6))*U1*U3+IXB*(SIN(Q4)*COS(Q6)
     &+SIN(Q5)*SIN(Q6)*COS(Q4))*(SIN(Q6)*COS(Q4)+SIN(Q4)*SIN(Q5)*COS(Q6)
     &)*U2*U3+IXB*(SIN(Q4)*COS(Q6)+SIN(Q5)*SIN(Q6)*COS(Q4))*(SIN(Q4)*SIN
     &(Q6)-SIN(Q5)*COS(Q4)*COS(Q6))*U3**2+IXB*(SIN(Q6)*COS(Q4)+SIN(Q4)*S
     &IN(Q5)*COS(Q6))*(COS(Q4)*COS(Q6)-SIN(Q4)*SIN(Q5)*SIN(Q6))*U2**2+IX
     &B*(SIN(Q4)*SIN(Q6)-SIN(Q5)*COS(Q4)*COS(Q6))*(COS(Q4)*COS(Q6)-SIN(Q
     &4)*SIN(Q5)*SIN(Q6))*U2*U3-IYB*U4*U5-IXB*SIN(Q6)*COS(Q5)*U1*U4-IYB*
     &COS(Q5)*COS(Q6)*U1*U5-IXB*SIN(Q6)*COS(Q6)*COS(Q5)**2*U1**2-IYB*(SI
     &N(Q4)*COS(Q6)+SIN(Q5)*SIN(Q6)*COS(Q4))*U3*U4-IYB*(SIN(Q6)*COS(Q4)+
     &SIN(Q4)*SIN(Q5)*COS(Q6))*U2*U5-IYB*(SIN(Q4)*SIN(Q6)-SIN(Q5)*COS(Q4
     &)*COS(Q6))*U3*U5-IYB*(COS(Q4)*COS(Q6)-SIN(Q4)*SIN(Q5)*SIN(Q6))*U2*
     &U4-IXB*SIN(Q6)*COS(Q5)*(SIN(Q6)*COS(Q4)+SIN(Q4)*SIN(Q5)*COS(Q6))*U
     &1*U2-IYB*COS(Q5)*COS(Q6)*(SIN(Q4)*COS(Q6)+SIN(Q5)*SIN(Q6)*COS(Q4))
     &*U1*U3-IXB*SIN(Q6)*COS(Q5)*(SIN(Q4)*SIN(Q6)-SIN(Q5)*COS(Q4)*COS(Q6
     &))*U1*U3-IYB*COS(Q5)*COS(Q6)*(COS(Q4)*COS(Q6)-SIN(Q4)*SIN(Q5)*SIN(
     &Q6))*U1*U2-IYB*(SIN(Q4)*COS(Q6)+SIN(Q5)*SIN(Q6)*COS(Q4))*(SIN(Q6)*
     &COS(Q4)+SIN(Q4)*SIN(Q5)*COS(Q6))*U2*U3-IYB*(SIN(Q4)*COS(Q6)+SIN(Q5
     &)*SIN(Q6)*COS(Q4))*(SIN(Q4)*SIN(Q6)-SIN(Q5)*COS(Q4)*COS(Q6))*U3**2
     &-IYB*(SIN(Q6)*COS(Q4)+SIN(Q4)*SIN(Q5)*COS(Q6))*(COS(Q4)*COS(Q6)-SI
     &N(Q4)*SIN(Q5)*SIN(Q6))*U2**2-IYB*(SIN(Q4)*SIN(Q6)-SIN(Q5)*COS(Q4)*
     &COS(Q6))*(COS(Q4)*COS(Q6)-SIN(Q4)*SIN(Q5)*SIN(Q6))*U2*U3) - MB*(LA
     &*PXpp*SIN(Q3)*COS(Q2)+LBO*PXpp*(SIN(Q4)*COS(Q6)+SIN(Q5)*SIN(Q6)*CO
     &S(Q4))*(SIN(Q2)*COS(Q4)*COS(Q5)+SIN(Q5)*COS(Q2)*COS(Q3)+SIN(Q3)*SI
     &N(Q4)*COS(Q2)*COS(Q5))+LBO*PZpp*(SIN(Q4)*COS(Q6)+SIN(Q5)*SIN(Q6)*C
     &OS(Q4))*(COS(Q1)*COS(Q2)*COS(Q4)*COS(Q5)+SIN(Q5)*(SIN(Q1)*SIN(Q3)-
     &SIN(Q2)*COS(Q1)*COS(Q3))-SIN(Q4)*COS(Q5)*(SIN(Q1)*COS(Q3)+SIN(Q2)*
     &SIN(Q3)*COS(Q1)))+LBO*PYpp*(SIN(Q4)*COS(Q6)+SIN(Q5)*SIN(Q6)*COS(Q4
     &))*(SIN(Q5)*(SIN(Q3)*COS(Q1)+SIN(Q1)*SIN(Q2)*COS(Q3))-SIN(Q1)*COS(
     &Q2)*COS(Q4)*COS(Q5)-SIN(Q4)*COS(Q5)*(COS(Q1)*COS(Q3)-SIN(Q1)*SIN(Q
     &2)*SIN(Q3)))+LBO*PYpp*COS(Q4)*COS(Q5)*(SIN(Q1)*COS(Q2)*(SIN(Q4)*CO
     &S(Q6)+SIN(Q5)*SIN(Q6)*COS(Q4))+SIN(Q6)*COS(Q5)*(SIN(Q3)*COS(Q1)+SI
     &N(Q1)*SIN(Q2)*COS(Q3))-(COS(Q1)*COS(Q3)-SIN(Q1)*SIN(Q2)*SIN(Q3))*(
     &COS(Q4)*COS(Q6)-SIN(Q4)*SIN(Q5)*SIN(Q6)))+LBO*PZpp*COS(Q4)*COS(Q5)
     &*(SIN(Q6)*COS(Q5)*(SIN(Q1)*SIN(Q3)-SIN(Q2)*COS(Q1)*COS(Q3))-COS(Q1
     &)*COS(Q2)*(SIN(Q4)*COS(Q6)+SIN(Q5)*SIN(Q6)*COS(Q4))-(SIN(Q1)*COS(Q
     &3)+SIN(Q2)*SIN(Q3)*COS(Q1))*(COS(Q4)*COS(Q6)-SIN(Q4)*SIN(Q5)*SIN(Q
     &6)))+LA*LBO*(SIN(Q6)*COS(Q4)+SIN(Q4)*SIN(Q5)*COS(Q6))*((SIN(Q4)*CO
     &S(Q5)*U2-U6-SIN(Q5)*U1-COS(Q4)*COS(Q5)*U3)**2+(SIN(Q6)*COS(Q5)*U1-
     &U5-(SIN(Q4)*COS(Q6)+SIN(Q5)*SIN(Q6)*COS(Q4))*U3-(COS(Q4)*COS(Q6)-S
     &IN(Q4)*SIN(Q5)*SIN(Q6))*U2)**2)-LA*PZpp*(SIN(Q1)*COS(Q3)+SIN(Q2)*S
     &IN(Q3)*COS(Q1))-LA*PYpp*(COS(Q1)*COS(Q3)-SIN(Q1)*SIN(Q2)*SIN(Q3))-
     &LBO*PXpp*COS(Q4)*COS(Q5)*(SIN(Q2)*(SIN(Q4)*COS(Q6)+SIN(Q5)*SIN(Q6)
     &*COS(Q4))-SIN(Q6)*COS(Q2)*COS(Q3)*COS(Q5)-SIN(Q3)*COS(Q2)*(COS(Q4)
     &*COS(Q6)-SIN(Q4)*SIN(Q5)*SIN(Q6)))-LA**2*U1*U2-LA*LBO*SIN(Q6)*COS(
     &Q4)*COS(Q5)**2*(U2**2+U3**2)-LA*LBO*SIN(Q4)*COS(Q5)*(SIN(Q4)*COS(Q
     &6)+SIN(Q5)*SIN(Q6)*COS(Q4))*U1*U2-LA*LBO*SIN(Q5)*(SIN(Q4)*COS(Q6)+
     &SIN(Q5)*SIN(Q6)*COS(Q4))*(U2**2+U3**2)-LA*LBO*COS(Q4)*COS(Q5)*(COS
     &(Q4)*COS(Q6)-SIN(Q4)*SIN(Q5)*SIN(Q6))*U1*U2-LBO**2*COS(Q4)*COS(Q5)
     &*(COS(Q5)*U1*Q5p+SIN(Q4)*SIN(Q5)*U2*Q5p-(U4+COS(Q5)*COS(Q6)*U1+(SI
     &N(Q6)*COS(Q4)+SIN(Q4)*SIN(Q5)*COS(Q6))*U2+(SIN(Q4)*SIN(Q6)-SIN(Q5)
     &*COS(Q4)*COS(Q6))*U3)*(SIN(Q6)*COS(Q5)*U1-U5-(SIN(Q4)*COS(Q6)+SIN(
     &Q5)*SIN(Q6)*COS(Q4))*U3-(COS(Q4)*COS(Q6)-SIN(Q4)*SIN(Q5)*SIN(Q6))*
     &U2)-SIN(Q4)*COS(Q5)*U3*Q4p-SIN(Q5)*COS(Q4)*U3*Q5p-COS(Q4)*COS(Q5)*
     &U2*Q4p)-LA*LBO*(COS(Q4)*COS(Q6)-SIN(Q4)*SIN(Q5)*SIN(Q6))*(COS(Q5)*
     &U1*Q5p+SIN(Q4)*SIN(Q5)*U2*Q5p-(U4+COS(Q5)*COS(Q6)*U1+(SIN(Q6)*COS(
     &Q4)+SIN(Q4)*SIN(Q5)*COS(Q6))*U2+(SIN(Q4)*SIN(Q6)-SIN(Q5)*COS(Q4)*C
     &OS(Q6))*U3)*(SIN(Q6)*COS(Q5)*U1-U5-(SIN(Q4)*COS(Q6)+SIN(Q5)*SIN(Q6
     &)*COS(Q4))*U3-(COS(Q4)*COS(Q6)-SIN(Q4)*SIN(Q5)*SIN(Q6))*U2)-SIN(Q4
     &)*COS(Q5)*U3*Q4p-SIN(Q5)*COS(Q4)*U3*Q5p-COS(Q4)*COS(Q5)*U2*Q4p)-LA
     &*LBO*SIN(Q4)*COS(Q5)*((SIN(Q4)*COS(Q5)*U2-U6-SIN(Q5)*U1-COS(Q4)*CO
     &S(Q5)*U3)*(U4+COS(Q5)*COS(Q6)*U1+(SIN(Q6)*COS(Q4)+SIN(Q4)*SIN(Q5)*
     &COS(Q6))*U2+(SIN(Q4)*SIN(Q6)-SIN(Q5)*COS(Q4)*COS(Q6))*U3)+SIN(Q5)*
     &SIN(Q6)*U1*Q5p-COS(Q5)*COS(Q6)*U1*Q6p-U2*(SIN(Q4)*COS(Q6)*Q4p+SIN(
     &Q6)*COS(Q4)*Q6p+SIN(Q4)*SIN(Q5)*COS(Q6)*Q6p+SIN(Q4)*SIN(Q6)*COS(Q5
     &)*Q5p+SIN(Q5)*SIN(Q6)*COS(Q4)*Q4p)-U3*(SIN(Q4)*SIN(Q6)*Q6p+SIN(Q4)
     &*SIN(Q5)*SIN(Q6)*Q4p-COS(Q4)*COS(Q6)*Q4p-SIN(Q5)*COS(Q4)*COS(Q6)*Q
     &6p-SIN(Q6)*COS(Q4)*COS(Q5)*Q5p))-LBO**2*(SIN(Q4)*COS(Q6)+SIN(Q5)*S
     &IN(Q6)*COS(Q4))*((SIN(Q4)*COS(Q5)*U2-U6-SIN(Q5)*U1-COS(Q4)*COS(Q5)
     &*U3)*(U4+COS(Q5)*COS(Q6)*U1+(SIN(Q6)*COS(Q4)+SIN(Q4)*SIN(Q5)*COS(Q
     &6))*U2+(SIN(Q4)*SIN(Q6)-SIN(Q5)*COS(Q4)*COS(Q6))*U3)+SIN(Q5)*SIN(Q
     &6)*U1*Q5p-COS(Q5)*COS(Q6)*U1*Q6p-U2*(SIN(Q4)*COS(Q6)*Q4p+SIN(Q6)*C
     &OS(Q4)*Q6p+SIN(Q4)*SIN(Q5)*COS(Q6)*Q6p+SIN(Q4)*SIN(Q6)*COS(Q5)*Q5p
     &+SIN(Q5)*SIN(Q6)*COS(Q4)*Q4p)-U3*(SIN(Q4)*SIN(Q6)*Q6p+SIN(Q4)*SIN(
     &Q5)*SIN(Q6)*Q4p-COS(Q4)*COS(Q6)*Q4p-SIN(Q5)*COS(Q4)*COS(Q6)*Q6p-SI
     &N(Q6)*COS(Q4)*COS(Q5)*Q5p)))
